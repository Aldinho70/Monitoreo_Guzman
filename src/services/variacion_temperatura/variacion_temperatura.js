            ...
            body_table += `
                    <tr class="">
                        ...
                        <td class="d-flex align-content-center justify-content-center">
                            <button class="btn btn-sm btn-warning"${element.historico_temperatura ? "" : "disabled"}  type="button" onClick="showTemperaturaVariacion('${element.Unidad}')" >
...
const showTemperaturaVariacion = async (unit_name) => {
...
window.showTemperaturaVariacion = showTemperaturaVariacion;