...
if (!isset($json['error'])) {
    ...
    //$geoscajas = $wialon_api->core_search_items('{"spec":{"itemsType":"avl_resource","propName":"geofences","propValueMask":"*","sortType":"sys_name"},"force":1,"flags":4611686018427387903,"from":0,"to":0}');
...
//print_r($arrtractos);
    ...
    // old username and password login is deprecated, use token login
    $token2 = 'd26901b3a1b754d30e264a18da1e24e37AC702FCC0735B72987A8FAFDD6E86F43350A5CB';
